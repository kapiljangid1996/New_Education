	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="category">Add Exam Results</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Exam Results</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/result/add_result')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
