...
@section('title','Add Exam Questions')
	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="category">Add Exam Questions</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Exam Questions</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/question/add_question')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
