...
@section('title','Edit Exam Preparation')
	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="category">Edit Exam Preparation</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Edit Exam Preparation</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/preparation/edit_preparation/'.$preparations->id)}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
					<div class="form-group row">
						<label for="name" class="col-sm-2 col-form-label">Heading</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="name" value="{{$preparations->name}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="slug" name="slug" value="{{$preparations->slug}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="long_description" required>{{$preparations->long_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="short_description" rows="3" required>{{$preparations->short_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="meta_name" value="{{$preparations->meta_name}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="checkbox" name="status" value="1" style="margin-top: 7px" @if(old('status', $preparations->status)) checked @endif>
						</div>
					</div>
