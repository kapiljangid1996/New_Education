	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{{url('/admin/exam/date/'.$id)}}">Dates</a></li>
				<li class="breadcrumb-item active" aria-current="category">Add Exam Dates</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Exam Dates</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/date/add_date')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
