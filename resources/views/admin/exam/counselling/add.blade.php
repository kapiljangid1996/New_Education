...
@section('title','Add Exam Counselling')
	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="category">Add Exam Counselling</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Exam Counselling</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/counselling/add_counselling')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
