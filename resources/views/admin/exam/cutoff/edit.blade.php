...
@section('title','Edit Exam Cut Offs')
	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{{url('/admin/exam/cutoff/'.$cutoffs->exams_id)}}">Cut Offs</a></li>
				<li class="breadcrumb-item active" aria-current="category">Edit Exam Cut Offs</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Edit Exam Cut Offs</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/cutoff/edit_cutoff/'.$cutoffs->id)}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
					<div class="form-group row">
						<label for="name" class="col-sm-2 col-form-label">Heading</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name" name="name" value="{{$cutoffs->name}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="slug" name="slug" value="{{$cutoffs->slug}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="long_description" required>{{$cutoffs->long_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea class="form-control" name="short_description" rows="3" required>{{$cutoffs->short_description}}</textarea>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="meta_name" value="{{$cutoffs->meta_name}}">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="checkbox" name="status" value="1" style="margin-top: 7px" @if(old('status', $cutoffs->status)) checked @endif>
						</div>
					</div>
