...
@section('title','Add Exam Answers')
	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="category">Add Exam Answers</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Exam Answers</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/answer/add_answer')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
