...
@section('title','Add Exam Application Form')
	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{{url('/admin/exam/appform/'.$id)}}">Application Form</a></li>
				<li class="breadcrumb-item active" aria-current="category">Add Exam Application Form</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Exam Application Form</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/exam/appform/add_appform')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
