...
@section('title','Exam Application Form')
	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="product">Exam Application Form</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12 my-4">
		<div class="card shadow">
			<div class="card-header">
				<strong class="card-title">Exam Application Form</strong>
			</div>
			<div class="card-body">
				<div class="toolbar">
					<div class="row">
						...
						<tr>
							...
							<td>
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="/admin/exam/appform/edit_appform/{{ $appform->id }}">Edit</a>
									<a class="dropdown-item" href="/admin/exam/appform/delete_appform/{{ $appform->id }}" onclick="return confirm('Are you sure you want to delete')">Delete</a>									
								</div>
							</td>
						</tr>
						<?php  } ?>
				...
				<ul style="margin-left: 10px">{!! "Page " . $appforms->currentPage() . " of " . $appforms->lastPage()  !!}</ul>
			</div>
		</div>
	</div>
</div>
