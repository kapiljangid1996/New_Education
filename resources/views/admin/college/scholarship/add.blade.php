	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{{url('/admin/college/scholarships/'.$id)}}">Scholarship</a></li>
				<li class="breadcrumb-item active" aria-current="category">Add Scholarship</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Scholarship</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/college/scholarships/add_scholarships')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
