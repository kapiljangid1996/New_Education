		...
		<div class="card shadow">
			...
			<div class="card-body">
				<div class="toolbar">
					<div class="row">
						<div class="col-sm-6">
							<a href="{{url('admin/college/scholarships/add_scholarships/'.$id)}}" class="btn btn-primary btn-round">Add</a>
						</div>
						<div class="col-sm-6">
				...
				<ul style="margin-left: 10px">{!! "Page " . $scholarships->currentPage() . " of " . $scholarships->lastPage()  !!}</ul>
			</div>
		</div>
	</div>
</div>
