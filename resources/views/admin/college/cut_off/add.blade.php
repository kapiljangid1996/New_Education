	...
	<div class="col">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="{{url('/admin/college/cut_offs/'.$id)}}">Cut Offs</a></li>
				<li class="breadcrumb-item active" aria-current="category">Add Cut Offs</li>
			</ol>
		</nav>
	</div>
</div>
	...
	<div class="col-md-12">
		<div class="card shadow mb-4">
			<div class="card-header">
				<strong class="card-title">Add Cut Offs</strong>
			</div>
			<div class="card-body">
				<form action="{{url('admin/college/cut_offs/add_cut_offs')}}" method="POST" enctype="multipart/form-data" class="form-group">
					@csrf
